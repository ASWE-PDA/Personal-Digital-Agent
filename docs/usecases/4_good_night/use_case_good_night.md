...
| Interfaces | Luna uses the Smart Home API to turn off the lights and set the temperature, and the Spotify API to get the sleep playlist. The alarm clock is set on the user's device.|

...
/// Class that stores an philips hue bridge configuration and notifies the app.
class BridgeModel extends ChangeNotifier {
  ...
  Future<void> deleteBridgePreferences() async {
  ...
  Future<void> getBridgePreferences() async {

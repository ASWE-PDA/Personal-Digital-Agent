...
class MockNewYorkTimesNews extends NewYorkTimesNews {
  @override
  ...
  @override
  Future<List<Article>> fetchSection(String input) {
    return Future.value([
      Article(
        title: 'Fake article 1',
        summary: 'Summary of fake article 1',
...
void main() {
  group('NewsAPI', ()
  {
    test('fetchNews returns a list of Articles', () async {
      final newsAPI = MockNewYorkTimesNews();
    ...
    test('fetchSection returns a list of Articles', () async {
      final newsAPI = MockNewYorkTimesNews();
      final articles = await newsAPI.fetchSection('section');
      expect(articles.length, equals(2));
      expect(articles[0].title, equals('Fake article 1'));
      expect(articles[0].summary, equals('Summary of fake article 1'));
      expect(articles[0].categories, equals(['Category 1', 'Category 2']));
